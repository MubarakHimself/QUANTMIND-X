    ...
    {#if messages.length === 0}
      ...
      <div class="welcome-state" transition:fade>
        ...
        <div class="quick-actions">
          <button class="quick-action-btn"> 📊 Run a backtest </button>
          <button class="quick-action-btn"> 📝 Analyze a strategy </button>
          <button class="quick-action-btn"> 🔧 Debug code </button>
        </div>
      </div>
    {:else}
        ...
        <div class="date-group">
          ...
          {#each dateMessages as message, msgIndex}
            {@const previousMessage =
              msgIndex > 0 ? dateMessages[msgIndex - 1] : null}
            {@const groupWithPrevious = shouldGroupWithPrevious(
              message,
              previousMessage,
            )}
