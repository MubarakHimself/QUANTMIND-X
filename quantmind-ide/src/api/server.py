...
try:
    ...
    from src.api.lifecycle_endpoints import router as lifecycle_router
    ...
    from src.api.correlation_sensor_endpoints import router as correlation_sensor_router  # Correlation Sensor
    from src.api.economic_calendar_endpoints import router as economic_calendar_router  # Economic Calendar
...
app.include_router(correlation_sensor_router)  # Correlation Sensor — eigenvalue/RMT analysis
app.include_router(lifecycle_router)  # Bot Lifecycle Stage Report API — needed on both nodes
