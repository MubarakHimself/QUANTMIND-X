...
def _make_tool(name: str, description: str):
    """STUB - Create a tool-like function pending Anthropic Agent SDK migration."""
    def decorator(func):
        func._is_tool = True
        func._name = name
...
class TaskQueueSkill(AgentSkill):
    def __init__(self, queue_dir: str = "data/queues"):
        ...
        # Tool functions - previously used @tool decorator
        ...
        push_to_queue._is_tool = True
        push_to_queue._name = "push_to_queue"
        ...
        list_queue._is_tool = True
        list_queue._name = "list_queue"
        ...
        pop_task._is_tool = True
        pop_task._name = "pop_task"
