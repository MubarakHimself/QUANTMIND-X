...
> **PRIMARY SDK for ROI Implementation** - See [knowledge/deepagents_reference.md](deepagents_reference.md) for detailed patterns.
...
| **Harness** | https://docs.langchain.com/oss/python/deepagents/harness | Filesystem tools, harness capabilities, write_todos |
| **Backends** | https://docs.langchain.com/oss/python/deepagents/backends | StateBackend, StoreBackend, FilesystemBackend, CompositeBackend |
| **Long-term Memory** | https://docs.langchain.com/oss/python/deepagents/long-term-memory | Persistent /memories/ path, instructions.md pattern |
| **Subagents** | https://docs.langchain.com/oss/python/deepagents/subagents | task() tool, spawning child agents |
| **HITL** | https://docs.langchain.com/oss/python/deepagents/human-in-the-loop | interrupt_on, approval flows, decisions |
